...
<head>
    ...
    <link href="<?php echo e(asset('assets/css/globales.css')); ?>" rel="stylesheet">
...
<nav class="navbar navbar-expand-lg navbar-light bg-white border-bottom py-3 sticky-top">
    <div class="container">
        ...
        <a class="navbar-brand fw-bold fs-4 text-danger" href="<?php echo e(url('/')); ?>">
            change.org
        </a>
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            ...
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                <li class="nav-item">
                    <a class="nav-link" href="<?php echo e(route('petitions.index')); ?>">Todas las peticiones</a>
                </li>
                <?php if(auth()->guard()->check()): ?>
                    <li class="nav-item">
                        <a class="nav-link <?php echo e(request()->routeIs('petitions.firmadas') ? 'active fw-bold' : ''); ?>"
                           href="<?php echo e(route('petitions.firmadas')); ?>">
                            Mis Firmas
                        </a>
                    </li>
                <?php endif; ?>
            ...
            <ul class="navbar-nav ms-auto mb-2 mb-lg-0 align-items-center">
                ...
                <li class="nav-item ms-2">
                    <a class="btn btn-danger rounded-pill px-4 fw-bold" href="<?php echo e(route('petitions.create')); ?>">
                        Inicia una petición
                    </a>
                </li>
            </ul>
...
<?php /**PATH C:\Users\Alumno\PhpstormProjects\change_Monolitic_Gonzalo (1)\change_Monolitic_Gonzalo_final\resources\views/layouts/public.blade.php ENDPATH**/ ?>